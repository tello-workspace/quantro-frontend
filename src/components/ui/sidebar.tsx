...
// asChild'siz basit bir "tek cocugu klonla" deseni - proje Radix Slot
// kullanmiyor (Base UI'in kendi render prop deseni var ama burada tek
// cocuk + className birlestirme yeterli, ekstra bagimliliga gerek yok).
function Slot({
  children,
  ...props
...
function Sidebar({
      ...
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        ...
        >
          <SheetHeader className="sr-only">
            ...
            <SheetDescription>Ana navigasyon menusu</SheetDescription>
          </SheetHeader>
  ...
  return (
    <div
      ...
      data-slot="sidebar"
    >
      {/* Sidebar gap: yandaki icerigin scroll'unu etkilemeyen "hayalet" boşluk */}
      <div
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      className={cn(
        "absolute inset-y-0 z-20 hidden w-4 -translate-x-1/2 transition-all ease-linear group-data-[side=left]:-right-4 group-data-[side=right]:left-0 after:absolute after:inset-y-0 after:left-1/2 after:w-0.5 hover:after:bg-sidebar-border group-data-[side=left]:cursor-w-resize group-data-[side=right]:cursor-e-resize sm:flex",
...
function SidebarMenuSkeleton({
  ...
  // Sabit genislik: Math.random() render sirasinda "impure" sayilip
  // react-hooks/compiler kuralini ihlal ediyordu - burada gorsel cesitlilik
  // (rastgele genislik) onemli degil, sabit bir deger yeterli.
  const width = "70%"
