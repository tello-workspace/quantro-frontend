...
export const api = createApi({
  ...
  tagTypes: ['Project', 'ProjectMember', 'Card', 'Notification', 'Insight', 'Chat', 'ChangeRequest', 'Me', 'MyAssignedCards', 'ApiToken', 'WatchedCards', 'Document', 'SavedView', 'ProjectTemplate', 'Webhook', 'Mail', 'GithubLink'],
  endpoints: () => ({}),
})
